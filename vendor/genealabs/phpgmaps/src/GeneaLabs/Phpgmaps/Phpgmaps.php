...
class Phpgmaps
{
    ...
    public $apiKey = 'AIzaSyAYzddCCCvKCG1J7svHqbO7MzT5sUE3f-Q';                        // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
    ...
    public function create_map()
    {
        ...
        if ($this->maps_loaded == 0) {
            if ($this->apiKey != "") {
                $apiLocation = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAYzddCCCvKCG1J7svHqbO7MzT5sUE3f-Q&';
            } else {
                $apiLocation = 'https://maps.google.com/maps/api/js?key=AIzaSyAYzddCCCvKCG1J7svHqbO7MzT5sUE3f-Q&';
            }
