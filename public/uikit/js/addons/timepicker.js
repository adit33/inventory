...
(function(addon) {
    ...
    for(var i = 0, h=''; i<24; i++) {
        ...
        times['24h'].push({value: (h+':10')});
        times['24h'].push({value: (h+':20')});
        times['24h'].push({value: (h+':30')});
        times['24h'].push({value: (h+':40')});
        times['24h'].push({value: (h+':50')});

        if (i<13) {
            times['12h'].push({value: (h+':00 AM')});
             times['12h'].push({value: (h+':10 AM')});
            times['12h'].push({value: (h+':20 AM')});
